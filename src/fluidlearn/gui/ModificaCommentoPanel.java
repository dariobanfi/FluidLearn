 ...
 * @author eddy
 */
public class ModificaCommentoPanel extends javax.swing.JPanel {

    private final Post post;
    private final Commento commento;
    List<Nodo> listaNodiCorso;
    List<Risorsa> risorse;

    public ModificaCommentoPanel(Commento c) {
        initComponents();
        this.post = c.getAzione();
        this.commento = c;
        ...
        for (int i = 0; i < listaNodiCorso.size(); i++) {
            ...
            for (Nodo n : c.getAzione().getNodi()) {
            }
    ...
    private void initComponents() {
        ...
        commentaButton = new javax.swing.JButton();
        ...
        commentaButton.setText("Commenta");
        commentaButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                commentaButtonActionPerformed(evt);
            }
        });
        jPanel1.add(commentaButton);
    ...
    private void commentaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_commentaButtonActionPerformed
        ...
        cpc.salvaCommento(this.commento, titoloJTF.getText(), testoJTA.getText(),
                nodiList, risorse);
        Gui.root.getContentPane().removeAll();
        Gui.root.getContentPane().add(new UdaPanel());
        Gui.root.setVisible(true);
    }//GEN-LAST:event_commentaButtonActionPerformed
    ...
    private javax.swing.JButton commentaButton;
